...
import sleevless from "../assets/sleeveless.jpg";
import sweater from "../assets/sweater.jpg";
import fullsleeve from "../assets/fullsleeve.webp";
import halfsleeve from "../assets/halfsleeve.webp";
    ...
    <>
      <div className="mt-24">
        <div className="bg-[#f4f5f8] py-24 flex justify-center items-center flex-col gap-2">
          <h1 className="text-[#2d2d2d] text-4xl font-bold">Men Products</h1>
          <p className="text-md text-[#474747] font-extralight ">
            Shirts / Collection / Men{" "}
          </p>
        </div>
      </div>
